             ...
             <div className="border-b border-white/5 pb-5 mb-6">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                        {failedChunksCount > 0 && processingState === 'idle' && (
                             <button
                                onClick={onRetryAllFailed}
                                className="p-2.5 text-red-500 hover:text-white hover:bg-red-500/10 rounded-2xl transition-all active:scale-90"
                                title="Thử lại tất cả lỗi"
                            >
